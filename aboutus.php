    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav pull-right">
       ...
       <li><a href="contactus.php"><span class="glyphicon glyphicon-earphone"></span> Contact Us</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="panel" style="padding-left:85px;padding-right:190px;">
                    <div class="panel-heading">
                    <h3 style="color:#ff3333;font-size:35px;">About<span style="color:#8c8c8c;font-size:20px"> Blood Bank</span></h3><hr>
                <ol class="breadcrumb">
                    <li><a href="index.php" style="color:#ff3333;">Home</a></li>
                    <li><a href="aboutus.php" style="color:#8c8c8c">About</a></li>
                </ol>
                </div>
                    <div class="panel-body">
                        <div class="col-sm-6">
                            <img src="Images/about.jpg" alt="about" class="img-responsive" style="width:450px;height:430px;padding-right:7px;padding-bottom:150px;margin-right:40px">
                        </div>
                        <div class="col-sm-6">
                              <h3 style="color:#ff3333">About Blood Bank</h3>
                             <p>A blood bank is a center where blood gathered as a result of blood donation is stored and preserved for later use in blood transfusion. The term "blood bank" typically refers to a division of a hospital where the storage of blood product occurs and where proper testing is performed (to reduce the risk of transfusion related adverse events).Whole blood or blood with RBC, is transfused to patients with anaemia/iron deficiency. It also helps to improve the oxygen saturation in blood. 
                             </p>
                        </div>
                    </div>
            </div>
