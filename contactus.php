        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4" style="margin-top:58px">
                    <h3 style="color:#ff3333">Contact Us</h3><hr>
                ...
                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOFxl8cKQrG2a_qjjHiD78rPGIxhbT9l8&callback=myMap"></script>
                  ...
                  <div class="col-sm-8">
                    ...
                    <h3 style="color:#ff3333;">Send Message</h3><hr>
                </div>
              <div class="panel-body">

              <form class="form-horizontal" method="post" action="contact.php" enctype="multipart/form-data" onSubmit="alert('Thank you for contacting us.We will get back soon.');">
