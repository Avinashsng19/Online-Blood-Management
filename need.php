                     ...
                     <div class="form-group" style="color:#ff3333">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="form-group" style="color:#ff3333">
                           ...
                           <div class="col-sm-10">          
                               <input type="tel" class="form-control" placeholder="Contact-1" name="contact1" pattern="^\d{10}$" required>
                           </div>
                       </div>
                       <div class="form-group" style="color:#ff3333">
                           <label class="control-label col-sm-2">Contact-2</label>
                           <div class="col-sm-10">          
                               <input type="tel" class="form-control"  placeholder="Contact-2" name="contact2"  pattern="^\d{10}$" required>
                           </div>
                       </div>
